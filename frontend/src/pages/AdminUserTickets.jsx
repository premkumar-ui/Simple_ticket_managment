...
const AdminUserTickets = () => {
                    ...
                    t.id === selectedTicket.id
                        ? {
                            ...
                            assigned_user: users.find(
                                (u) => u.id === selectedTicket.assigned_to
                            ),
                        }
                        : t
                )
    ...
    return (
        <div className="px-6 bg-gray-100 text-gray-900">
            <div className="flex justify-between items-center mb-1 lg:mr-7">
                <h2 className="text-xl font-bold">Tickets</h2>
                <div className="">
                    <label className="text-sm font-medium">Search by User </label>
                    <select
                        onChange={(e) =>
                            fetchTickets(Number(e.target.value))
                        }
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="mt-3 text-sm text-end">
                                    <p className="text-start text-gray-600 text-[14px]">Assigned to : {t.assigned_user.name} </p>
                                    <button onClick={() => {
                                        setSelectedTicket(t);
                                        setIsModalOpen(true);
                                    ...
                                    }} className="text-xs font-medium px-2 py-1  ml-3 text-white bg-indigo-300 rounded hover:bg-indigo-400">Reassign</button>
                                </div>
