...
const AdminDashboard = () => {
  ...
  return (
    <div className="px-6 py-1 bg-gray-100 text-gray-900">
              ...
              >
                ...
                <div className="mt-4 text-sm text-end">
                  ...
                  <button onClick={() => {
                    setSelectedTicket(t);
                    setIsModalOpen(true);
                  }} className="text-xs font-medium px-2 py-1 mt-2 text-white bg-indigo-300 rounded hover:bg-indigo-400">Edit</button>
                  <button onClick={() => {
                    setSelectedTicket(t);
                    setAssignModalOpen(true);
                  }} className="text-xs font-medium px-2 py-1 mt-2 ml-3 text-white bg-indigo-300 rounded hover:bg-indigo-400">Assign</button>
                </div>
              </div>
            );
          })
